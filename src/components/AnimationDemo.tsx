  ...
  return (
    <div className='max-w-4xl mx-auto p-8 space-y-8'>
      ...
      <section>
        ...
        <Accordion type='single' collapsible className='w-full'>
          <AccordionItem value='item-1'>
            <AccordionTrigger>
              accordion-down/up 애니메이션이란?
            </AccordionTrigger>
            <AccordionContent>
              tw-animate-css의 accordion-down/up 클래스를 사용하여 부드러운 높이
              변화 애니메이션을 제공합니다. Radix UI의 data-state 속성과
              연동되어 자동으로 작동합니다.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value='item-2'>
            ...
            <AccordionContent>
              data-[state=open]:animate-accordion-down과
              data-[state=closed]:animate-accordion-up 클래스가 상태 변화에 따라
              자동으로 적용됩니다.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value='item-3'>
            ...
            <AccordionContent>
              네! 아래에서 Dialog, 커스텀 애니메이션 등 다양한 예제를 확인하실
              수 있습니다.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
        ...
        <Dialog>
          ...
          <DialogContent className='sm:max-w-[425px]'>
            <DialogHeader>
              ...
              <DialogDescription>
                이 Dialog는 tw-animate-css의 fade-in과 zoom-in 애니메이션을
                사용합니다. 부드럽게 나타나고 사라지는 효과를 확인해보세요!
              </DialogDescription>
            </DialogHeader>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='animate-in slide-in-from-top-4 fade-in-0 duration-700 delay-200 bg-purple-50 border border-purple-200 rounded-lg p-4'>
            ...
            <p className='text-purple-800 text-sm'>
              slide-in-from-top-4 + fade-in + delay-200
            </p>
          </div>
          ...
          <div className='animate-in slide-in-from-right-8 fade-in-0 duration-700 delay-300 bg-orange-50 border border-orange-200 rounded-lg p-4'>
            ...
            <p className='text-orange-800 text-sm'>
              slide-in-from-right-8 + fade-in + delay-300
            </p>
          </div>
        ...
        <div className='bg-gray-50 rounded-lg p-6 space-y-4'>
          <div>
            ...
            <ul className='text-sm space-y-1 font-mono'>
              <li>
                • <code>animate-in</code> / <code>animate-out</code> - 기본
                enter/exit
              </li>
              <li>
              ...
              <li>
                • <code>zoom-in-95</code> / <code>zoom-out-105</code> - 크기
                변화
              </li>
              <li>
      ...
      <section>
        ...
        <p className='text-sm text-muted-foreground'>
          tw-animate-css를 사용하여 버튼에 다양한 애니메이션 효과를 적용할 수
          있습니다. 아래 버튼을 클릭해보세요!
        </p>
        <div className='mt-4'>
          <Button
